...
public record CreateRetailerRequest(
        ...
        @NotBlank(message = "Retailer code is required")
        @Size(max = 50, message = "Retailer code must not exceed 50 characters")
        @Pattern(regexp = "^[A-Za-z0-9_-]+$", message = "Retailer code may only contain letters, digits, hyphens and underscores")
        String retailerCode,
